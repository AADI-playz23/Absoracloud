// render_server/server.js
// AbsoraCloud Master Render Backend Server — Request Verifier, User Auth, Worker Trigger Engine & Uptime Heartbeat
...
import { executePostgresQuery } from './lib/postgres.js';
import { executeD1Query } from './lib/d1.js';
import { redisCommand } from './lib/redis.js';
import { hashPassword, verifyPassword, signToken, requireAuth } from './lib/auth.js';
import { triggerGitHubVpsRunner, triggerKaggleZeroGpuDevbox, wakeAndVerifyHfSpace, handleSmartVpsLaunch } from './lib/orchestrator.js';
